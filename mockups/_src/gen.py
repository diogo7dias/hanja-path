...
CURATED = {
 ...
 "家": {"eng":"house, family",
   ...
   "s":{"ko":"주말에 가족과 함께 외식을 했어요.","en":"I ate out with my family on the weekend.","w":"가족"}},  "心": {"eng":"heart, mind",
  ...
  "學": {"eng":"learn, study",
   "tip":"지붕 아래 아이가 지식을 배우는 모습. 어른의 가르침이 아이에게 전해지는 것.",
   "words":[("학교","學校","school"),("학생","學生","student"),("학습","學習","study, learning")],
 ...
 "德": {"eng":"virtue, moral",
   ...
   "s":{"ko":"미덕을 실천하는 사람이 되고 싶어요.","en":"I want to become someone who practices virtue.","w":"미덕"}},  "義": {"eng":"righteousness, justice",
   "tip":"나(我)를 양(羊)처럼 올바르고 고귀하게 만드는 것. 정의·의리를 뜻한다.",
   "words":[("정의","正義","justice"),("의리","義理","loyalty, duty"),("의의","意義","meaning")],
